  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className='text-xl md:text-2xl font-bold mb-5 text-primary-color dark:text-light-color'
      >
        Any Question?
      </motion.h3>
      <div className='w-100 flex flex-col gap-10 md:flex-row '>
        <div className='w-100 md:w-4/6'>
          ...
          >
            <input
              type='text'
              name='name'
              className='p-3 text-sm bg-light-color dark:bg-background-color text-primary-color dark:text-light-color border-secondary-color border-b outline-none active:border-b-accent-color focus:border-b-accent-color'
              placeholder='Name'
              required
            />
            <input
            ...
            <textarea
              name='message'
              className='p-3 text-sm bg-light-color dark:bg-background-color text-primary-color dark:text-light-color border-secondary-color border-b outline-none active:border-b-accent-color focus:border-b-accent-color resize-none'
        ...
        >
          <h1 className='font-bold text-xl md:text-2xl text-primary-color dark:text-light-color'>
            Let&apos;s talk about it.
          </h1>
